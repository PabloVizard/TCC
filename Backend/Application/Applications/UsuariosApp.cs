...
namespace Application.Applications
{
    public class UsuariosApp : BaseApp<Usuarios, UsuariosModel>, IUsuariosApp
    {
        ...
        public UsuariosLightModel ObterUsuarioLightPorId(int idUsuario)
        {
            ...
            return new UsuariosLightModel { id = usuario.id, nomeCompleto = usuario.nomeCompleto, email = usuario.email, tipoUsuario = usuario.tipoUsuario, matricula = usuario.matricula, cpf = usuario.cpf };
        }
    }
}
